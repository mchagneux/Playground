...
//==============================================================================
NeuralProcessorComponent::NeuralProcessorComponent (NeuralProcessor& p)
    : processorRef (p), backendSelector(p.getValueTreeState()), dryWetSlider(p.getValueTreeState()), apvts(p.getValueTreeState())
{
